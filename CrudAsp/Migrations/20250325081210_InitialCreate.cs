    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("28b04af0-4c76-4b3b-a228-ab74145274c7"), "Comedy", new DateTime(2025, 3, 25, 16, 12, 10, 13, DateTimeKind.Local).AddTicks(4020), new DateTime(2025, 3, 25, 16, 12, 10, 13, DateTimeKind.Local).AddTicks(4030) },
                    { new Guid("77fc3686-06de-46f3-b101-a99bc100bc3e"), "Sci-Fi", new DateTime(2025, 3, 25, 16, 12, 10, 13, DateTimeKind.Local).AddTicks(4020), new DateTime(2025, 3, 25, 16, 12, 10, 13, DateTimeKind.Local).AddTicks(4020) },
                    { new Guid("96ce5b07-a7e1-4809-b533-825072893f0a"), "Horror", new DateTime(2025, 3, 25, 16, 12, 10, 13, DateTimeKind.Local).AddTicks(4030), new DateTime(2025, 3, 25, 16, 12, 10, 13, DateTimeKind.Local).AddTicks(4030) },
                    { new Guid("b0f2337a-cadb-4849-a98a-87660c371d25"), "Action", new DateTime(2025, 3, 25, 16, 12, 10, 13, DateTimeKind.Local).AddTicks(3960), new DateTime(2025, 3, 25, 16, 12, 10, 13, DateTimeKind.Local).AddTicks(3980) },
                    { new Guid("d9530102-224b-41a2-bd87-1cbe7b636acc"), "Drama", new DateTime(2025, 3, 25, 16, 12, 10, 13, DateTimeKind.Local).AddTicks(4010), new DateTime(2025, 3, 25, 16, 12, 10, 13, DateTimeKind.Local).AddTicks(4010) }
                });
